...
const Product = ({post}) => {
  ...
  return (
    ...
    hover:scale-110  transition-all duration-200 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl 
    shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] 
    hover:shadow-[0_30px_90px_rgba(0,0,0,0.4),_0_50px_150px_rgba(0,0,0,0.25)]">
